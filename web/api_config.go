...
func (s *AdminServer) handleGetConfig(w http.ResponseWriter, r *http.Request) {
	...
	jsonResponse(w, http.StatusOK, map[string]interface{}{
		...
		"web": map[string]interface{}{
			...
			"alert_error_threshold_pct":  cfg.Web.AlertErrorThreshold,
			"alert_latency_threshold_ms": cfg.Web.AlertLatencyMs,
			"auto_update":                cfg.Web.AutoUpdate,
			"update_check_interval":      cfg.Web.UpdateCheckInterval.String(),
			"dashboard": map[string]interface{}{
				"panel_order":   cfg.Web.Dashboard.PanelOrder,
				"hidden_panels": cfg.Web.Dashboard.HiddenPanels,
			},
